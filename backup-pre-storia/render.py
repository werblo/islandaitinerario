...
days = [
 {'id':'d1','num':1,'dateISO':'2026-11-15','dateLabel':'Dom 15 nov','title':'Arrivo & Reykjavík','locKey':'reykjavik',
  ...
  'tips':"Giornata di arrivo tranquilla: sistematevi con calma e fate un po' di spesa in un Bónus per i giorni successivi. Avrete un paio di soste alle terme nel resto del viaggio, più economiche e meno turistiche della Blue Lagoon. Parcheggio: l'appartamento non ne ha uno incluso e Laugavegur è zona P1 (~650 ISK/h, max 3h consecutive nei feriali). Appena arrivati conviene spostare l'auto verso Hlemmur/Rauðarárstígur (zona P2, ~230 ISK/h, senza limite di 3h) o nel garage Stjörnuport a 5 min a piedi — molto più comodo per 3 notti ferme. Gratis di notte e la domenica in tutta la città.",
